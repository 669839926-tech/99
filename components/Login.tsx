...
const Login: React.FC<LoginProps> = ({ users, players, onLogin, onGoogleLogin, appLogo }) => {
                    ...
                    <form onSubmit={handleStaffLogin} className="space-y-4 md:space-y-5">
                        ...
                        <div className="relative my-6">
                            ...
                            <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-black">
                                <span className="bg-white px-4 text-gray-300">或者使用</span>
                            </div>
                        </div>
                        ...
                        <button 
                            ...
                            className="w-full bg-white border-2 border-gray-100 text-gray-600 font-black py-4 rounded-2xl hover:bg-gray-50 transition-all flex items-center justify-center gap-3 shadow-sm active:scale-95 uppercase tracking-widest text-xs"
                        >
