...
export const MOCK_PLAYERS: Player[] = [
  ...
  createMockPlayer({ id: '7', teamId: 't2', name: '埃姆雷·詹 (Jr)', gender: '男', idCard: mockId(2007), birthDate: '2007-01-01', number: 23, position: Position.CDM, isCaptain: false, age: 16, goals: 1, assists: 3, appearances: 12, image: 'https://picsum.photos/200/200?random=7', reviews: [], credits: 30, validUntil: getNextYear(), leaveQuota: 3, leavesUsed: 0, rechargeHistory: [{ id: 'init-7', date: '2023-01-01', amount: 30, quotaAdded: 3 }] }),
];
