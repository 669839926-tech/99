...
export const DEFAULT_ATTRIBUTE_CONFIG: AttributeConfig = {
  ...
  trainingFoci: [
    { name: '传接球', topics: ['短传配合', '长传转移', '接球转身', '传球精度'] },
    { name: '射门', topics: ['禁区外远射', '门前抢点', '1对1面对门将', '头球攻门'] },
    { name: '防守', topics: ['个人防守姿势', '小组协防', '阵型保持', '拦截传球'] },
    { name: '体能', topics: ['耐力训练', '爆发力训练', '灵敏协调', '核心力量'] },
    { name: '战术', topics: ['进攻套路', '防守反击', '定位球战术', '高位逼抢'] },
    { name: '对抗', topics: ['1对1对抗', '2对2小组对抗', '小场地比赛', '全场对抗'] }
  ]
};
