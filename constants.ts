...
const generateStats = (): PlayerStats => {
  ...
  // Dynamically generate based on keys in default config to match structure
  const stats: any = {
    technical: {},
    tactical: {},
    physical: {},
  ...
  // Generate realistic stats between 4 and 9 for field players
