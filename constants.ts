...
export const DEFAULT_ATTRIBUTE_CONFIG: AttributeConfig = {
  ...
  trainingFoci: [
    { id: 'f1', name: '传接球', themes: ['短传配合', '长传转移', '接球转身', '撞墙配合'] },
    { id: 'f2', name: '射门', themes: ['禁区外远射', '门前包抄', '1对1面对门将', '头球攻门'] },
    { id: 'f3', name: '防守', themes: ['个人防守姿势', '小组协防', '阵型保持', '高位逼抢'] },
    { id: 'f4', name: '体能', themes: ['有氧耐力', '无氧爆发', '灵敏协调', '核心力量'] },
    { id: 'f5', name: '战术', themes: ['进攻三区渗透', '防守反击', '边路传中战术', '定位球攻防'] },
    { id: 'f6', name: '对抗', themes: ['1对1身体对抗', '2对2小组对抗', '高强度分队比赛'] }
  ]
};
