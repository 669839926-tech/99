...
export const DEFAULT_ATTRIBUTE_CONFIG: AttributeConfig = {
  ...
  trainingFoci: [
    ...
    { id: 'f3', name: '防守', themes: ['个人防守姿势', '小组协同防守', '防守阵型保持', '高位压迫'] },
    { id: 'f4', name: '体能', themes: ['耐力训练', '爆发力训练', '灵敏协调', '核心力量'] },
    { id: 'f5', name: '战术', themes: ['进攻组织', '防守反击', '边路进攻', '定位球战术'] },
    { id: 'f6', name: '对抗', themes: ['1v1对抗', '小场地对抗', '全场对抗', '身体对抗'] }
  ]
};
